...
st.subheader("1. Log New Home Observation")
name = st.text_input("Child Name", key="unique_child_name_2026")
name = st.text_input("Child Name", key="unique_child_name_2026")
r = st.slider("Routine Sync", 1, 10, 5, key="unique_routine_sync_2026")
r = st.slider("Routine Sync", 1, 10, 5, key="unique_routine_sync_2026")
s = st.slider("Home Scaffolding", 1, 10, 5, key="unique_home_scaffold_2026")
s = st.slider("Home Scaffolding", 1, 10, 5, key="unique_home_scaffold_2026")
g = st.slider("Goal Alignment", 1, 10, 5, key="unique_goal_align_2026")
g = st.slider("Goal Alignment", 1, 10, 5, key="unique_goal_align_2026")
btn = st.button("Submit Data", key="unique_submit_btn_2026")
btn = st.button("Submit Data", key="unique_submit_btn_2026")
